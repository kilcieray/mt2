...
                st.session_state.track_list = data
                save_to_db(data); st.success("Yükleme Başarılı!"); st.rerun()
...
kodda düzeltmeni istediğim yerler var filtrelerde + ile efsun ekleme özelliği vardı onu + ile blok ekleme olsun açılan bloktan efsun vnum sockets gibi seçecekler seçiyim örnek olarak datada sana veri bloklarından bikac tane veriyim {"id":4,"vnum":55712,"name":"Nakliye Kutusu","seller":"J3LuEWoLF","yangPrice":0,"wonPrice":745,"quantity":1,"category":"1-2","job":0,"attrs":[],"sockets":[1774782101,1772190101,756483],"rand":[],"set":0,"elem":[],"changelookvnum":0,"petInfo":[55712,6,[105,0,4,1672607410,"CYROS","29.5","20.8","36.1","Æ¯¼öÁøÈ­",0,0,0],[3,20,20,0,6,20,0,9,20,0],[]]}, {"id":49465,"vnum":86008,"name":"Chou Bandı (kişiye özel)","seller":"MPOWERARTI","yangPrice":0,"wonPrice":1150,"quantity":1,"category":"9-3","job":0,"attrs":[[72,40],[22,10],[3,6],[6,6],[250,2],[214,8]],"sockets":[2209,25],"rand":[],"set":0,"elem":[101,[6,8,6],[4,2,6]],"changelookvnum":0,"petInfo":null} program arayüzünü de daha profesyonel ve modern yap 
