...
# --- GÜVENLİ DOSYA YOLLARI ---
# Streamlit Cloud üzerinde yazma izni olan /tmp klasörünü kullanmak bazen daha stabildir
DB_FILE = "filters_db.json"
STATE_FILE = "bot_state.json"
SENT_ITEMS_FILE = "sent_items.json"

# --- GÜVENLİ DOSYA FONKSİYONLARI ---
def save_to_db(data):
    try:
...
# --- BACKGROUND ENGINE (KOLAY ERİŞİM) ---
def tracker_worker():
